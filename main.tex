...
\section{Programming Skills}
 \resumeSubHeadingListStart
   \item{
     \textbf{Languages}{: C\#, JavaScript/TypeScript, Python, SQL, Bash}
     \hfill
     \textbf{Technologies}{: .Net 8, Next JS, React, Dapper, Entity Framework}
   }
 \resumeSubHeadingListEnd
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Express Employment Professionals SA }{Pretoria, Irene}
      {.NET Software Developer (Full Stack Developer)}{Jan 2022 - Present}
      \resumeItemListStart
        \resumeItem{Git}
        ...
        \resumeItem{Entity Framework Core}
          {Instructor dashboards and learner surveying tools, which helped instructors run their class better by providing data on Assignments and Learner Activity.}
      \resumeItemListEnd
...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeSubItem{Carpentry Shop – Web Application}
      {Open source python library for financial data analysis and machine learning for finance.}
    \resumeSubItem{Github Visualization}
      {Data Visualization of Git Log data using D3 to analyze project trends over time.}
    \resumeSubItem{System Online Cellphone Store}
      {Music and Movie recommender systems using collaborative filtering on public datasets.}
    \resumeSubItem{User Management}
